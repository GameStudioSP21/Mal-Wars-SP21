...
Tower.OnFired:Connect(function()
    ...
    --spiiiiiin
    Ease3D.EaseRotation(BARREL, currentBarrelRot + Rotation.New(360, 0, 0), 1, Ease3D.EasingEquation.ELASTIC, Ease3D.EasingDirection.OUT)
    --Ease3D.EaseRotation(REAR_SPINNER, currentSpinnerRot + Rotation.New(360, 0, 0), 1, Ease3D.EasingEquation.ELASTIC, Ease3D.EasingDirection.OUT)
